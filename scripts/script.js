...
let ArtworkSrcs = Array("GratFumo.png", "Butt.gif", "Butt2.gif", "IlluProfile.png", "Lampreyhole.png", "OfflineScreenGratVer1.png", "Sprite-0001.png", "Skærmbillede 2022-08-04 230758.png", "GratMebo.gif", "RotatePanties.gif", "Skærmbillede 2022-09-10 173921.png", "SpinGifHOT.gif");
let ArtworkAlt = Array("Fumo Grat", "Icon of the Motherbrain Discord", "Prototype Icon", "Illu Winks!", "Lampreyhole", "OfflineScreen", "Sprite-0001", "H.O.T's Mascot!", "Please Place on a Skylanders™ portal", "Around The World", "A N G E R Y", "H.O.T's Model!");
